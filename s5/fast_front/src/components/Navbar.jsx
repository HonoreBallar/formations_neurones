...
export default function Navbar({handeLogout}){
    return (
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div className="flex space-x-4">
                        <div className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">
                            <Link to="/">
                                Accueil
                            </Link>
                        </div>
                        ...
                        <a onClick={handeLogout} className="rounded-md px-3 py-2 text-sm font-medium text-blue-300 hover:bg-gray-700 hover:text-white">Se deconnecter</a>
